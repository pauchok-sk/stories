    ...
    function pay() {
        ...
        if (inputOwnSum && inputsSum.length) {
            ...
            function uncheckInputSum() {
                const currentCheckInputSum = document.querySelector(".input-check[name='sum-help']:checked");
                if (currentCheckInputSum) currentCheckInputSum.checked = false;
            }
        }
    }
    function payModalTitle() {
